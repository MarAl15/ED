...
/**
  ...
  *
  * Sea T, un árbol general sobre el tipo Tbase, 
  * entonces el invariante de la representación es:
  *
  * Si T es vacío, entonces T.laraiz=0, y si no:
  * T.laraiz->padre = 0 y
  * para todo n nodo de T, n->izqda != n->drcha
  * y para todo n, m nodos de T, si n->izqda = m,
  * entonces m->padre = n y si n->drcha = m, luego 
  * m->padre->izqda = n o m->padre->izqda->drcha = n o
  * ... o m->padre->izqda->drcha->...->drcha.
  *
  * @section faConjunto Función de abstracción
  *
  * Sea T un árbol General sobre el tipo Tbase, entonces si
  * lo denotamos también rbol(T.laraiz), es decir, como el 
  * árbol que cuelga de una raíz, entonces este árbol del
  * conjunto de valores en la representación se aplica al
  * árbol
  *
